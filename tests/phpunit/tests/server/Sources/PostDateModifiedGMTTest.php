...
use OTGS_TestCase;
use stdClass;
use Toolset\DynamicSources\Sources\PostDateModifiedGMT;
use WP_Mock;

class PostDateModifiedGMTTest extends OTGS_TestCase {
	...
	public function setUp() {
		...
		$this->subject = new PostDateModifiedGMT();

		global $post;
		$post = new stdClass();
		$post->post_modified_gmt = self::SAMPLE_DATE;
	}
	...
	public function it_gets_the_title() {
		$this->assertEquals( 'Post Modified Date GMT', $this->subject->get_title() );
	}
