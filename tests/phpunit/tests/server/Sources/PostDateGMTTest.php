...
use OTGS_TestCase;
use stdClass;
use Toolset\DynamicSources\Sources\PostDateGMT;
use WP_Mock;

class PostDateGMTTest extends OTGS_TestCase {
	...
	public function setUp() {
		...
		$this->subject = new PostDateGMT();

		global $post;
		$post = new stdClass();
		$post->post_date_gmt = self::SAMPLE_DATE;
	}
	...
	public function it_gets_the_title() {
		$this->assertEquals( 'Post Date GMT', $this->subject->get_title() );
	}
